...
import {
  ...
  Check, Clock, PackageCheck, Search, Truck, X,
} from 'lucide-react'
import api, { fmt } from '../utils/api'
import { OWNERSHIP_TONES, OWNERSHIP_LABELS } from './LarcDevices'
import EmptyState from '../components/EmptyState'
import CheckoutReadyList from '../components/larc/CheckoutReadyList'
...
// records the device ID. The list + per-row form is the shared CheckoutReadyList
// (also used by the LARC nav drawer and My Checklist).
function LarcCheckoutCard() {
  ...
  return (
    <div className="card border-plum-100 bg-plum-50/30">
      ...
      {open && <div className="mt-3"><CheckoutReadyList /></div>}
    </div>
  )
}
