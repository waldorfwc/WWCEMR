  ...
  return (
    <div className="bg-white border border-amber-200 rounded p-2.5">
      <div className="flex items-baseline gap-2 mb-1">
        ...
        <span className="text-[10px] text-muted">signed by {cert.trainer_email} on {cert.trainer_signed_at?.slice(0, 10)}</span>
      </div>
    ...
    <li className="py-2 flex items-baseline gap-3">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-[10px] text-gray-500">
          ...
          {cert.trainee_signed_at && <> · acknowledged {cert.trainee_signed_at.slice(0, 10)}</>}
        </div>
      </div>
