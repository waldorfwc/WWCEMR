...
export default function PelletPortalLogin() {
  ...
  async function submit(e) {
    ...
    setErr(''); setBusy(true)
    try {
      const { data } = await pelletPortalApi.post('/login', { dob, last4 })
      nav('/pellet-portal/verify', { state: { challenge_token: data.challenge_token } })
    } catch (e) {
