...
app.include_router(patient_larc.router, prefix="/api")
...
# LARC reports: summary tiles + drill-down rows/CSV
...
# Pellet reports — summary + drill-down rows/CSV
app.include_router(pellet_reports.router, prefix="/api")
# Pellet Recall — worklist of patients due for re-insertion
